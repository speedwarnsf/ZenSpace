          ...
          >
            <div className="relative aspect-[4/3] overflow-hidden">
              ...
              {!canSaveToMoodBoard(userTier) && (
                <span className="absolute top-3 right-14 bg-amber-100 dark:bg-amber-900 text-amber-700 dark:text-amber-300 text-[10px] font-bold px-1.5 py-0.5 opacity-0 group-hover:opacity-100 transition-opacity uppercase tracking-wider">
                  Pro
                </span>
              )}
            </div>
