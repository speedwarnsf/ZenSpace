  ...
  return (
    <div className="flex items-center gap-2 text-stone-400 dark:text-stone-500 mb-8">
      ...
      <span className="text-sm">
        <span className="font-semibold text-stone-600 dark:text-stone-300 tabular-nums">{count.toLocaleString()}</span> designs generated by the ZenSpace community
      </span>
    </div>
  );
}
          ...
          <div className="flex flex-col items-center justify-center min-h-[60vh] animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {userTier.tier === 'pro' && (
              <p className="text-sm text-emerald-500 dark:text-emerald-400 mb-8">
                Pro — {userTier.generationsLimit - userTier.generationsUsed} designs remaining this month
              </p>
            )}
